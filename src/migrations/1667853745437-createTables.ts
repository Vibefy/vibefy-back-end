...
export class createTables1667853745437 implements MigrationInterface {
    name = 'createTables1667853745437'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "playlists_users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "users_count" integer NOT NULL, "userId" uuid, "playlistId" uuid, CONSTRAINT "PK_a6856b83b783a3503e3d9b3e33f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "playlists_musics" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "music_count" integer NOT NULL, "playlistId" uuid, "musicId" uuid, CONSTRAINT "PK_c035464035faa029608c5e70357" PRIMARY KEY ("id"))`);
