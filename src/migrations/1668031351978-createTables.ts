...
export class createTables1668031351978 implements MigrationInterface {
    name = 'createTables1668031351978'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "avatar_img" character varying NOT NULL DEFAULT 'https://www.lance.com.br/files/article_main/uploads/2022/04/29/626c07807ccfa.jpeg', "password" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "created_At" date NOT NULL, "updated_At" date NOT NULL, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
