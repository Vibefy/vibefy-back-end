...
export class initialCreate1667513260114 implements MigrationInterface {
    name = 'initialCreate1667513260114'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "avatar_img" character varying NOT NULL DEFAULT 'https://www.lance.com.br/files/article_main/uploads/2022/04/29/626c07807ccfa.jpeg', "password" character varying NOT NULL, "isActive" character varying NOT NULL DEFAULT true, "created_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.936Z"', "updated_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.936Z"', "paymentId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_e0bd6fdbf43b798bda889642dc" UNIQUE ("paymentId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "playlist" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "link_playlist" character varying NOT NULL, "created_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.937Z"', "updated_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.937Z"', CONSTRAINT "PK_538c2893e2024fabc7ae65ad142" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "music" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "artistName" character varying NOT NULL, "genre" character varying NOT NULL, "description" character varying NOT NULL, "duration" double precision NOT NULL, "created_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.938Z"', "updated_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.938Z"', "artistId" uuid, CONSTRAINT "PK_c92b010dd889692dd54286f75e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "artist" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "avatar_img" character varying NOT NULL DEFAULT 'https://www.lance.com.br/files/article_main/uploads/2022/04/29/626c07807ccfa.jpeg', "password" character varying NOT NULL, "isActive" character varying NOT NULL DEFAULT true, "created_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.938Z"', "updated_At" date NOT NULL DEFAULT '"2022-11-03T22:07:46.938Z"', CONSTRAINT "UQ_66b179caee88b4a3f0bb46533d4" UNIQUE ("email"), CONSTRAINT "PK_55b76e71568b5db4d01d3e394ed" PRIMARY KEY ("id"))`);
