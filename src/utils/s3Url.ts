export const s3MusicUrl = (objectAws : string)=>
{
    return `https://vibefy.s3.sa-east-1.amazonaws.com/musics/${objectAws}`
}
export const s3ImageUrl = (objectAws : string) =>
{
    return `https://vibefy.s3.sa-east-1.amazonaws.com/musics/${objectAws}`
}
export const s3AvatarUserUrl = (objectAws : string)=>
{
    return `https://vibefy.s3.sa-east-1.amazonaws.com/avatar/user/${objectAws}`
}
export const s3AvatarArtistUrl = (objectAws : string)=>
{
    return `https://vibefy.s3.sa-east-1.amazonaws.com/avatar/artist/${objectAws}`
}
export const s3AvatarAdmUrl = (objectAws : string)=>
{
