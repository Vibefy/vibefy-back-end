...
const createAdmService = ({ name, email, password, admHash, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (admHash !== process.env.ADM_HASH) {
        throw new appError_1.AppError(401, "Hash invalid");
    }
    const adm = new adm_entity_1.default();
    adm.name = name;
    adm.email = email;
    adm.password = passwordHash;
    amdRepository.create(adm);
    yield amdRepository.save(adm);
    return (0, class_transformer_1.classToPlain)(adm);
});
